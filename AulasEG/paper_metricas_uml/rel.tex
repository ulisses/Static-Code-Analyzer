...
Este conjunto de métricas são referidas em vários papers e são sem sombra de dúvidas as mais estudas e também as mais utilizadas para avaliar modelos UML. Têm em conta principalmente os diagramas de classe, visto estes serem os que mais facilmente se transformam em código e também porque dão uma boa visão geral do sistema. Estas métricas em particular são definidas por McQuillan e Power em (referencia a http://www.minds.nuim.ie/~jmcq/NUIM-CS-TR-2006-03.pdf). Existe também um software (SDMetrics) que avalia além destas, um conjunto mais extenso de métricas, que analisa outros diagramas além do de classes, como por exemplo os diagramas de estados e de actividades.
